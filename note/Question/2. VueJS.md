...
- [ ] How to know that nodes have not changed to skipp diffing
...
- [ ] Patch Flags (Vue 3 Optimization). Vue 3 introduces patch flags during template compilation. These flags describe what parts of a node can change, so Vue can skip unnecessary checks. How vue know 0 is static and 1 is dynamic.
